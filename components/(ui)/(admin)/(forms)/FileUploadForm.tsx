...
export default function MultiImageDropzoneUsage() {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <p className='text-center text-red-500 font-bold'> برای اپلود عکس ها اسم عکس ها باید به این گونه باشد  نام دسته بندی-نوع عکس-اسم ععکس برای مثال banner-good-akselaptop</p>
    </div>
  );
}
